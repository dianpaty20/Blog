...
class PostController extends BaseController
{
    ...
    public function ejercicio06()
    {
        ...
        $data = [
            ...
            'postPorAutor' => $postsPorAutor
        ];
        return view('posts/ejercicio06');
    }
    ...
    public function ejercicio07()
    {
        ...
        $postsEscritosPorMujeres =$db->query('select p. *, count (*) as pepm u.*, ul.* from posts as p join users as u on p.autor = u.id join userinfo as ui on u.id = ui. id where ui.gender = “f” and p.created_at between “2022/01/01” and “2022/12/31”')->getResultArray();

        $data = [
            'postsEscritosPorMujeres' => $postsEscritosPorMujeres
        ];
